		...
		<div class="container-xl">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="blog-single.html#">{{str()->headline($post->category->title)}}</a></li>
                    ...
                    <div class="post post-single">
						...
						<div class="post-header">
							...
							<ul class="meta list-inline mb-0">
								<li class="list-inline-item"><a href="blog-single.html#"><img src="images/other/author-sm.png" class="author" alt="author"/>{{$post->user->name }}</a></li>
								<li class="list-inline-item"><a href="blog-single.html#">{{ $post->type }}</a></li>
